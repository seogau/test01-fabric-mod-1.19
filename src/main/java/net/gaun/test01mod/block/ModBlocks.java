package net.gaun.test01mod.block;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.gaun.test01mod.Test01_Mod;
import net.gaun.test01mod.block.custom.EggplantCropBlock;
import net.gaun.test01mod.block.custom.JumpyBlock;
import net.gaun.test01mod.block.custom.TanzaniteLampBlock;
import net.gaun.test01mod.item.ModItemGroup;
...
public class ModBlocks {
    ...
    private static Block registerBlockWithoutItem(String name, Block block){
        return Registry.register(Registry.BLOCK, new Identifier(Test01_Mod.MOD_ID, name), block);
    }
    ...
    private static Item registerBlockItem(String name, Block block, ItemGroup tab){
        ...
        return Registry.register(Registry.ITEM, new Identifier(Test01_Mod.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings().group(tab)));
    }


    public static void registerModBlocks(){
        Test01_Mod.LOGGER.debug("Registering ModBlocks for "+ Test01_Mod.MOD_ID);
    }
}
